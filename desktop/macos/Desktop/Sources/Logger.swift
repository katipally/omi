...
/// `@unchecked` is accurate rather than a suppression: the contract above
/// restricts `values` to enums, booleans, and numeric measurements, all of
/// which are `Sendable`. `[String: Any]` simply cannot express that.
