...
/// A consistent circular icon button for toolbars and page headers: neutral at
/// rest, a soft white wash on hover, a brighter fill when active. Matches the
/// chip and segmented-control language so every header control reads as one set.
